...
public static class AStar {
  ...
  public static List<Vector3> FindPath(Vector3 source, Vector3 destination, float search_boundary = 20f, float grid_granularity = 1f, float agent_size = 1f, float near_stopping_distance = 3f) {

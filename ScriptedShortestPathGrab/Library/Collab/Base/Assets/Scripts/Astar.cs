...
public static class AStar {
  ...
  static List<FastVector3> NeighbouringNodes(Vector3 current_point, float grid_granularity = 0.5f) {
  ...
  public static List<Vector3> SimplifyPath(List<Vector3> path, float sphere_cast_radius = 0.3f) {
